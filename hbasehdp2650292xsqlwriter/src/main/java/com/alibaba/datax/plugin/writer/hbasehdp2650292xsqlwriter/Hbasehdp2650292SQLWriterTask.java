 ...
 * @author yanghan.y
 */
public class Hbasehdp2650292SQLWriterTask {
    private final static Logger LOG = LoggerFactory.getLogger(Hbasehdp2650292SQLWriterTask.class);

    private TaskPluginCollector taskPluginCollector;
    private Hbasehdp2650292SQLWriterConfig cfg;
    ...
    public Hbasehdp2650292SQLWriterTask(Configuration configuration) {
        // 这里仅解析配置，不访问远端集群，配置的合法性检查在writer的init过程中进行
        cfg = Hbasehdp2650292SQLHelper.parseConfig(configuration);
    }
    ...
    public void startWriter(RecordReceiver lineReceiver, TaskPluginCollector taskPluginCollector) {
        ...
        try {
            ...
            throw DataXException.asDataXException(Hbasehdp2650292SQLWriterErrorCode.PUT_HBASE_ERROR, t);
        } finally {
            close();
        }
    }
    ...
    private void prepare() throws SQLException {
        if (connection == null) {
            connection = Hbasehdp2650292SQLHelper.getJdbcConnection(cfg);
    ...
    private void doBatchUpsert(List<Record> records) throws SQLException {
        try {
            ...
            throw DataXException.asDataXException(Hbasehdp2650292SQLWriterErrorCode.PUT_HBASE_ERROR, e);
        }
    }
    ...
    private PreparedStatement createPreparedStatement() throws SQLException {
        ...
        if (cfg.isThinClient()) {
            ...
            // upsertBuilder = new StringBuilder("upsert into \"" + tableName + "\" (" + columnNames + " ) values (");
            upsertBuilder = new StringBuilder("upsert into "
    ...
    private int[] getColumnSqlType(List<String> columnNames) throws SQLException {
        ...
        PTable ptable = Hbasehdp2650292SQLHelper
