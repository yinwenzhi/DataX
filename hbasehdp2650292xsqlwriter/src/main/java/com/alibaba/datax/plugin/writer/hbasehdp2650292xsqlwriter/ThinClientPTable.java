...
public class ThinClientPTable implements PTable {
  ...
  @Override
  public PColumn getColumn(String s) throws ColumnNotFoundException, AmbiguousColumnException {
    if (!colMap.containsKey(s)) {
      throw new ColumnNotFoundException("Col " + s + " not found");
    }
    return colMap.get(s);
  }
...
//  }
  ...
  @Override
  public PRow newRow(KeyValueBuilder keyValueBuilder, long l, ImmutableBytesWritable immutableBytesWritable, byte[]... bytes) {
    throw new UnsupportedOperationException("Not implement");
  }
...
//  }
  ...
  @Override
  public PRow newRow(KeyValueBuilder keyValueBuilder, ImmutableBytesWritable immutableBytesWritable, byte[]... bytes) {
    throw new UnsupportedOperationException("Not implement");
  }
