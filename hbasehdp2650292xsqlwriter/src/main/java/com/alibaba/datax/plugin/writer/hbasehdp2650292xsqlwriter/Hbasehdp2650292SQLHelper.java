 ...
 * @author yanghan.y
 */
public class Hbasehdp2650292SQLHelper {
    private static final Logger LOG = LoggerFactory.getLogger(Hbasehdp2650292SQLHelper.class);
     ...
     */
    public static Hbasehdp2650292SQLWriterConfig parseConfig(Configuration cfg) {
        return Hbasehdp2650292SQLWriterConfig.parse(cfg);
    }
     ...
     * 校验配置
     */
    public static void validateConfig(Hbasehdp2650292SQLWriterConfig cfg) {
        ...
        try {
            ...
            throw DataXException.asDataXException(Hbasehdp2650292SQLWriterErrorCode.GET_HBASE_CONNECTION_ERROR,
...
//                schema.getColumnForColumnName(colName);
     ...
     */
    public static Connection getJdbcConnection(Hbasehdp2650292SQLWriterConfig cfg) {
     ...
     * @throws SQLException
     */
    public static Connection getThinClientJdbcConnection(Hbasehdp2650292SQLWriterConfig cfg) throws SQLException {
        String connStr = cfg.getConnectionString();
    ...
    public static void truncateTable(Connection conn, String tableName) {
        ...
        try {
            ...
            // 清空表失败
            throw DataXException.asDataXException(Hbasehdp2650292SQLWriterErrorCode.TRUNCATE_HBASE_ERROR,
    ...
    private static void checkTable(Admin admin, TableName tableName) throws IOException {
        ...
        if(!admin.tableExists(tableName)){
            System.out.println("可用的表为: " + tableNames);
            throw DataXException.asDataXException(Hbasehdp2650292SQLWriterErrorCode.ILLEGAL_VALUE,
    ...
    private static void closeAdmin(Admin admin){
        try {
            ...
            throw DataXException.asDataXException(Hbasehdp2650292SQLWriterErrorCode.CLOSE_HBASE_AMIN_ERROR, e);
        }
    }
}
